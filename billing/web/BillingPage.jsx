...
export default function BillingPage({ refreshShell = () => {} }) {
  ...
  function setSubscriptionServiceOrder(serviceOrderId) {
    ...
    const serviceDate = order.billingStartDate || order.activationDate || order.requestedDate;
    setSubscriptionForm({
      ...subscriptionForm,
      serviceOrderId,
      ...
      startDate: serviceDate || subscriptionForm.startDate,
      nextInvoiceDate: serviceDate || subscriptionForm.nextInvoiceDate
    });
  }
