...
const OrderSummary = ({ Discount, total }: BillsAddressProps) => {
  return (
    <>
      <OutlineCard className="p-10 mt-6 shadow-none rounded-md">
        ...
        <div className="flex flex-col gap-5 mt-3">
          <div className="flex justify-between gap-3 items-center">
            <p className="text-base text-ld opacity-70 font-medium">Sub Total</p>
            <h6 className="text-base">${total}</h6>
          </div>
          <div className="flex justify-between gap-3 items-center">
            <p className="text-base text-ld opacity-70 font-medium">Discount 5%</p>
