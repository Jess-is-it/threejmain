      ...
      {post ? (
        <>
          <Card className="p-0 overflow-hidden">
            ...
            <hr className="my-0 mb-4 border-gray-200 dark:border-gray-700" />
            <div className="px-6 pb-6">
              ...
              <ul className="list-disc text-darklink pl-6 flex flex-col gap-1">
              ...
              <ol className="list-decimal text-darklink pl-6 flex flex-col gap-1">
                <li>Gigure out what it is or</li>
                <li>The links it currently</li>
                <li>It allows you to start your bid</li>
                <li>Gigure out what it is or</li>
          ...
          <Card className="mt-6">
            ...
            ></Textarea>
            <Button className="w-fit mt-3 rounded-md" onClick={onSubmit}>
              Post Comment
            </Button>
            <div className="mt-6">
