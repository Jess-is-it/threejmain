        ...
        <CardContent className="flex flex-col gap-3">
          <div className=" flex items-center space-x-4 rounded-md border border-ld p-4">
            ...
            <div className="flex-1 space-y-1">
              <p className="text-15 font-semibold text-ld leading-none">Push Notifications</p>
            ...
            {notifications.map((notification, index) => (
              ...
              >
                ...
                <div className="space-y-1">
                  <p className="text-15 font-semibold text-ld leading-none">{notification.title}</p>
