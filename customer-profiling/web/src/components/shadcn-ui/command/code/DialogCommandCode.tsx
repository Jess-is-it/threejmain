  ...
  return (
    <>
      <p className="text-sm text-ld flex gap-2 mt-4">
        Press
        <kbd className="pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded bg-lightprimary dark:bg-dark p-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100">
