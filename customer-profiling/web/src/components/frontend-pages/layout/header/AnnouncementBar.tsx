import ellpise from 'src/assets/images/frontend-pages/background/left-ellipse.png';
  ...
  return (
    <>
      ...
      >
        ...
        <p className="text-fs_13 text-white font-medium">Frontend Pages Added</p>
        <img src={ellpise} alt="ellipse" className="absolute top-0 start-0 lg:block hidden" />
        <div
