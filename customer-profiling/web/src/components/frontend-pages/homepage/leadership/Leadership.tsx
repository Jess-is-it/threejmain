...
// Images Used
import leader1 from 'src/assets/images/frontend-pages/leaders/leader1.jpg';
import leader2 from 'src/assets/images/frontend-pages/leaders/leader2.jpg';
import leader3 from 'src/assets/images/frontend-pages/leaders/leader3.jpg';
import leader4 from 'src/assets/images/frontend-pages/leaders/leader4.jpg';
      ...
      <div className="lg:pt-24 lg:pb-[66px] pb-[18px] container-md px-4 pt-12">
        <div className="flex justify-between items-center flex-wrap md:gap-0 gap-2">
          <div className="flex flex-col gap-4">
            <h1 className="leading-tight text-link dark:text-white font-bold md:text-40 text-32 ">
              Our leadership
            </h1>
              ...
              return (
                <SwiperSlide key={item.key}>
                  <div className="img-wrapper">
                    <img src={item.img} alt="leader-image" className="rounded-2xl" />
                    <div className="px-6">
                      <div className="rounded-[10px] z-20 relative bg-white dark:bg-dark text-center custom-shadow2 -mt-10 py-4 px-3">
                        <h1 className="text-lg text-link dark:text-white font-semibold">
                          {item.name}
                        </h1>
