              ...
              <div className="xl:col-span-3 md:col-span-6 col-span-12" key={item.key}>
                <div className="p-7 rounded-2xl border border-border dark:border-darkborder">
                  <div className="pb-8 border-b border-border dark:border-darkborder">
                    <h6 className="text-xl font-bold text-link dark:text-white mb-4 flex items-center gap-2">
                      {item.licenseType}
                      {item.isPopular ? (
                        <Badge variant={'lightPrimary'} className="font-bold py-2 rounded-md">
                          Popular
                        </Badge>
                      ) : null}
                    </h6>
                  ...
                  <div className="flex gap-2 pt-8 ">
                    <div className="md:text-40 text-32 leading-tight font-bold text-link dark:text-white">
                      {item.price}
                    </div>
                  ...
                  <div className="mt-8">
                    <Button asChild>
                      <Link to={'https://tailwind-admin.com/pricing'} target='_blank' className="text-lg font-medium w-full">
                        Purchase Now
                      </Link>
                    </Button>
                  </div>
