...
import customer1 from 'src/assets/images/profile/user-1.jpg';
import customer2 from 'src/assets/images/profile/user-2.jpg';
import customer3 from 'src/assets/images/profile/user-3.jpg';
      ...
      <div className="container-md lg:py-24 py-12 px-4">
        <div className="grid grid-cols-12 gap-6">
            ...
            <div className="flex w-full">
              <div className="lg:w-9/12 w-full">
                <h4 className="md:text-40 text-32 leading-tight text-link font-bold dark:text-white mb-4 pe-10">
                  ...
                  <img src={LogoIcon} alt="logo" height={24} className="inline-block mx-2" /> about
                  us?
                </h4>
                <p className="text-base text-lightmutes dark:text-darklink leading-relaxed">
          ...
          <div className="lg:col-span-6 col-span-12">
            <div className="rounded-2xl border border-border dark:border-darkborder p-12">
              <h6 className="text-2xl font-semibold text-link dark:text-white mb-8">
              ...
              <div>
                      ...
                      <SwiperSlide key={item.key}>
                        <div className="img-wrapper pb-6 border-b border-border dark:border-darkborder">
                          <div className="flex items-center gap-4 mb-6">
                            ...
                            />
                            <h6 className="text-base font-bold text-link dark:text-white">
                              {item.name}
                            </h6>
                          </div>
                ...
                <div className="flex items-center gap-2 mt-6">
                  ...
                  >
                    <Icon
                      icon={`${
                        activeDir === 'ltr' ? 'tabler:chevron-left' : 'tabler:chevron-right'
                      }`}
                  ...
                  >
                    <Icon
                      icon={`${
                        activeDir === 'ltr' ? 'tabler:chevron-right' : 'tabler:chevron-left'
                      }`}
                      className="shrink-0 text-xl"
                    />
                  </div>
