...
// Images used
import darkimg from "src/assets/images/landingpage/demos/demo-dark.png"
import horizontalimg from "src/assets/images/landingpage/demos/demo-horizontal.png"
import mainimg from "src/assets/images/landingpage/demos/demo-main.png"
import minimg from "src/assets/images/landingpage/demos/demo-mini.png"
import rtlimg from "src/assets/images/landingpage/demos/demo-rtl.png"
          ...
          <div className="slider-container" >
            <Slider ref={sliderRef} {...settings}  >
              <div className="px-3 pb-10 focus:outline-0">
                <img src={darkimg} alt="demos" className="max-w-full w-full rounded-md custom-shadow" />
              </div>
              <div className="px-3 pb-10 focus:outline-0">
                <img src={horizontalimg} alt="demos" className="max-w-full w-full rounded-md custom-shadow" />
              </div>
              <div className="px-3 pb-10 focus:outline-0">
                <img src={darkimg} alt="demos" className="max-w-full w-full rounded-md custom-shadow" />
              </div>
              <div className="px-3 pb-10 focus:outline-0">
                <img src={mainimg} alt="demos" className="max-w-full w-full rounded-md custom-shadow" />
              </div>
              <div className="px-3 pb-10 focus:outline-0">
                <img src={minimg} alt="demos" className="max-w-full w-full rounded-md custom-shadow" />
              </div>
              <div className="px-3 pb-10 focus:outline-0">
                <img src={rtlimg} alt="demos" className="max-w-full w-full rounded-md custom-shadow" />
              </div>
            </Slider>
          </div>
          <div className="mt-8">
