...
import secondBg from 'src/assets/images/frontend-pages/background/Scene.png';
        ...
        <div className="flex w-full lg:flex-nowrap flex-wrap gap-6">
          <div className="lg:w-[28%] w-full">
            <div className=" py-12 px-6 justify-center rounded-2xl bg-lightwarning dark:bg-lightwarning mb-6">
              <img src={briefcase} alt="image" className="mx-auto" />
            ...
            <div className=" pt-12 px-6 justify-center rounded-2xl bg-lightsuccess dark:bg-lightsuccess">
              ...
              <img src={appWidget} alt="image" className="mx-auto px-6" />
            </div>
          </div>
          <div className="lg:w-5/12 w-full">
            <div className=" py-12 px-6 justify-center rounded-2xl bg-lightprimary dark:bg-lightprimary">
              <img src={logoicon} alt="image" className="mx-auto" width={52} />
              <h1 className="py-4 font-bold text-link dark:text-white text-center md:text-40 text-32 leading-normal">
                New Demos
              </h1>
              ...
              <img src={secondBg} className="xl:mt-4 lg:mt-20 mt-4 lg:px-6 px-0" alt="image" />
            </div>
          </div>
          <div className="lg:w-[28%] w-full">
            <div className=" py-12 px-6 justify-center rounded-2xl bg-lightsuccess dark:bg-lightsuccess mb-6">
              <img src={speechicon} alt="image" className="mx-auto" />
              <h1 className="py-4 text-center font-bold text-link dark:text-white text-lg">
                Code Improvements
              </h1>
              <p className="text-lightmuted dark:text-darklink text-base font-normal text-center">
            ...
            <div className=" py-12 px-6 justify-center rounded-2xl bg-lighterror dark:bg-lighterror">
              <img src={iconfavourite} alt="image" className="mx-auto" />
              <h1 className="py-4 text-center font-bold text-link dark:text-white text-lg">
                50+ UI Components
              </h1>
              <p className="text-lightmuted dark:text-darklink text-base font-normal text-center">
