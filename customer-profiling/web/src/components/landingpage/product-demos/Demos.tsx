        ...
        <div className="container">
          <div className="lg:w-3/5 w-full mx-auto" data-aos="fade-up" data-aos-duration="500">
            <div className="sm:flex text-center mx-auto block items-center gap-3 justify-center">
              ...
              <h5 className="text-base">52,589+ developers & agencies using our templates</h5>
            </div>
            <h2 className="text-center sm:text-4xl text-2xl mt-8 font-bold sm:!leading-[45px]">
              Production Ready & Developer Friendly Tailwind Reactjs Admin Template
            </h2>
          </div>
          {/* Demos */}
          <AllDemos />
          ...
          {/* Apps */}
          <div className="mt-12">
            <Badge className="mb-5 py-2 px-6 text-base">Apps</Badge>
            <AllApps />
          </div>
          {/* Apps */}
          <div className="mt-12">
            <Badge className="mb-5 !py-3 px-6 text-base">Frontend Pages</Badge>
            <FrontPages />
          </div>
        </div>
      </div>
