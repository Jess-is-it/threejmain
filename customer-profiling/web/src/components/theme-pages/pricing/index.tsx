...
const PricingIndex = () => {
  ...
  const yearlyPrice = (a: number | string, b: number) => Number(a) * b;
    ...
    <>
      ...
      <div className="flex justify-center">
        <div className="flex gap-2">
          <span className="text-sm text-dark dark:text-white font-semibold">Monthly</span>
          <Switch checked={switch1} onCheckedChange={() => setSwitch1(!switch1)} />
          <span className="text-sm text-dark dark:text-white font-semibold">Yearly</span>
        </div>
      </div>
        ...
        {pricing.map((price, i) => (
          <div className="md:col-span-4 col-span-12" key={i}>
            <Card className="relative">
              ...
              <h6 className="text-xs font-bold opacity-70 uppercase">{price.package}</h6>
              <img src={price.avatar} alt="icon" width={90} height={90} className="my-6" />
              <div>
                {price.plan == 'Free' ? (
                  ...
                  <div className="flex">
                    ...
                    {switch1 ? (
                      ...
                      <>
                        <h2 className="text-5xl font-bold">{price.monthlyplan}</h2>
                        <p className="text-base text-dark opacity-70 dark:text-white mt-3 ms-1.5">
                          /mo
                        </p>
                      </>
