...
import img9 from 'src/assets/images/profile/user-2.jpg';
...
const checkboxTableData: TableType4[] = [
  {
    invoice: 'INV-3066',
    status: 'paid',
    statuscolor: 'primary',
...
export { basicTableData, basicTableData2, basicTableData3, basicTableData4, basicTableData5, checkboxTableData };
