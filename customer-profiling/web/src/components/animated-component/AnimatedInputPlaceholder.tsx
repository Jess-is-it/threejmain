    ...
    return (
      <form onSubmit={handleSubmit} className={cn('relative flex w-full items-center transition')}>
        ...
        <Input
          ...
          disabled={disabled}
          className={cn(
            ' w-full bg-transparent pl-10 pr-20 text-sm text-black focus:outline-none dark:text-white sm:text-base',
          ...
          <AnimatePresence mode="wait">
            {!value && (
              <motion.p
                ...
                className={cn(
                  `w-[calc(100%-2rem)] truncate text-sm text-lightmuted pl-10 sm:text-sm`,
                  className,
                )}
              >
