    ...
    <div className="row row-cards customer-profile-page">
      ...
      <div className="col-12 col-xl-4">
        <Card title="Service Orders" icon={IconWifi}>
          {!selected && <div className="empty">Select a customer to view service orders.</div>}
          {selected && serviceOrders.map((order) => (
          ...
          {selected && !serviceOrders.length && <div className="text-muted">No service orders.</div>}
        </Card>
