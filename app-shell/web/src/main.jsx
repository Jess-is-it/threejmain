...
function SystemSettingsPage({ refresh }) {
  const tabs = ['General', 'Ports', 'Access', 'Runtime'];
  ...
  async function save(e) {
    e.preventDefault();
    const saved = await request('/system/settings', { method: 'PATCH', body: JSON.stringify(settings) });
    setSettings(saved);
      ...
      <div className="page-wrapper">
        ...
        <div className="page-body">
          <div className="container-xl">
            ...
            {moduleNav.filter((item) => !['Dashboard', 'Customer Profiling', 'Billing', 'Point of Sale', 'System Settings', 'Logs'].includes(item.page)).map((item) => (
