...
- Public shell branding comes from System Settings -> General. `/api/public/branding` returns safe display fields and cache-busted URLs for uploaded company logo and browser page logo assets; `/api/public/branding/company-logo` and `/api/public/branding/browser-logo` serve those uploaded assets publicly. The web shell applies the company logo in the sidebar and the browser page logo as the document favicon.
